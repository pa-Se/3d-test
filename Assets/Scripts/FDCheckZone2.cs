...
public class FDCheckZone2 : MonoBehaviour
{
    ...
    void Start()
    {
        transform.position = new Vector3(-0.11f, -0.45f, -2.65f);
    ...
    void set_position(GameObject dice)
    {
        ...
        dice.transform.parent.position = new Vector3(-0.08093941f, 0.4062f, -2.737124f);
        this.snapped = true;
    }
