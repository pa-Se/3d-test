...
public class FDCheckZone3 : MonoBehaviour
{
    ...
    void Start()
    {
        transform.position = new Vector3(1.23f, -0.45f, -2.66f);
    ...
    void set_position(GameObject dice)
    {
        ...
        dice.transform.parent.position = new Vector3(1.241745f, 0.4062f, -2.737124f);
        this.snapped = true;
    }
